...
const CoursesPromo: React.FC<CoursesPromoProps> = ({ setView, data }) => {
  return (
    <div className="py-16 md:py-24 bg-card/20 border-y border-card/50">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
            <div className="w-16 h-16 flex items-center justify-center bg-primary/20 text-primary rounded-full mx-auto mb-6">
                <BookOpenIcon />
            </div>
