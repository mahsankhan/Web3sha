...
const TermsOfServiceModal: React.FC<TermsOfServiceModalProps> = ({ content, onClose }) => {
  return (
    ...
    >
      <div 
        className="bg-card w-full max-w-3xl max-h-[90vh] rounded-lg shadow-2xl relative flex flex-col"
      ...
      >
        ...
        <div className="p-6 md:p-8 overflow-y-auto">
          <p className="text-gray-400 mb-6">{content.introduction}</p>
          <div className="space-y-6">
            {content.sections.map((section, index) => (
              <div key={index}>
                <h3 className="text-lg font-semibold text-light mb-2">{section.title}</h3>
