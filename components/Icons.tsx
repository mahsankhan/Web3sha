...
export const SparklesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.528l-.259-1.035a3.375 3.375 0 00-2.456-2.456L13.149 16.5l1.035-.259a3.375 3.375 0 002.456-2.456l.259-1.035.259 1.035a3.375 3.375 0 002.456 2.456l1.035.259-1.035.259a3.375 3.375 0 00-2.456 2.456l-.259 1.035z" />
    </svg>
);

export const LightbulbIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311V21m-3.75-2.311V21m0 0a1.5 1.5 0 01-1.5 1.5h-3a1.5 1.5 0 01-1.5-1.5m1.5-1.5h3.75m-3.75 0h-3.75m6.75 0v-1.5c0-3.314-2.686-6-6-6s-6 2.686-6 6v1.5m6 0h-3.75" />
    </svg>
);
...
export const CertificateIcon: React.FC<{ className?: string }> = ({ className = "w-16 h-16 text-primary" }) => (
...
export const RocketIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.95 14.95 0 00-5.84-2.56m0 0a14.95 14.95 0 00-5.84 2.56m5.84-2.56V4.72a.75.75 0 00-1.5 0v4.82m0 0a6 6 0 01-5.84-7.38V5.25a.75.75 0 011.5 0v4.82m5.84 7.38a6 6 0 00-5.84-7.38m5.84 7.38V18a.75.75 0 001.5 0v-4.82m-7.38 0a14.95 14.95 0 00-5.84 2.56m5.84-2.56a14.95 14.95 0 005.84 2.56m0 0V18a.75.75 0 001.5 0v-4.82m0 0a6 6 0 005.84-7.38V5.25a.75.75 0 00-1.5 0v4.82m-5.84-7.38a6 6 0 005.84 7.38" />
    </svg>
);

export const UsersIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.964A4.5 4.5 0 1115 11.25a4.5 4.5 0 01-6 0zM12 6.75a4.5 4.5 0 11-6 0 4.5 4.5 0 016 0z" />
    </svg>
);

export const BriefcaseIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.998a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.52-1.42l3.5-4.5a2.25 2.25 0 012.87-.67l1.12.55a2.25 2.25 0 002.87-.67l3.5-4.5a2.25 2.25 0 01.52-1.42v4.07a2.25 2.25 0 01-2.25 2.25H5.998a2.25 2.25 0 01-2.25-2.25v-4.07" />
    </svg>
);
...
export const CommentIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.068.158 2.222.266 3.414.364.573.046 1.155.087 1.752.115 2.223.102 4.505-.246 6.523-1.26.628-.258 1.23-.566 1.787-.92.556-.354 1.058-.76 1.5-1.215L21 12.76c0-1.6-1.123-2.994-2.707-3.227-1.068-.158-2.222-.266-3.414-.364-.573-.046-1.155-.087-1.752-.115-2.223-.102-4.505.246-6.523 1.26-.628.258-1.23.566-1.787.92-.556.354-1.058.76-1.5 1.215L2.25 12.762z" />
    </svg>
);
