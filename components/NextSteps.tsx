...
const NextSteps: React.FC<NextStepsProps> = ({ setView, courses, currentCourse }) => {
    ...
    return (
        <div className="bg-background/50 rounded-lg p-6 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                {recommendedCourse && (
                    <div className="bg-card p-6 rounded-lg border border-gray-700 flex flex-col items-center">
                        <RocketIcon />
                        ...
                        <button 
                            ...
                            className="w-full mt-auto bg-primary/20 hover:bg-primary/40 text-primary font-semibold py-2 px-4 rounded-lg transition-colors duration-300"
                        >
                            View Paid Courses
                        </button>
                    </div>
                ...
                <div className="bg-card p-6 rounded-lg border border-primary/50 flex flex-col items-center ring-2 ring-primary/30">
                     <UsersIcon />
