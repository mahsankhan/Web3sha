        ...
        <div className="bg-card rounded-lg shadow-lg">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left text-sm text-gray-300">
                    <thead className="bg-background/50 text-xs text-gray-400 uppercase">
                        <tr>
                    ...
                    <tbody>
                        {leads.length > 0 ? (
                            leads.map(lead => (
                                <tr key={lead.id} className="border-b border-gray-700 hover:bg-card/50">
                                    <th scope="row" className="px-6 py-4 font-medium text-light whitespace-nowrap">{lead.name}</th>
                            ...
                            <tr>
                                <td colSpan={4} className="text-center py-8 text-gray-400">No leads have been captured yet.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
